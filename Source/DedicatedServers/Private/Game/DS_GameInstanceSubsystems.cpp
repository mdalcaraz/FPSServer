...
UDS_GameInstanceSubsystems::UDS_GameInstanceSubsystems()
{
	bGameLiftInitialized = false;
}

void UDS_GameInstanceSubsystems::InitGameLift(const FServerParameters& ServerParams)
{
...
void UDS_GameInstanceSubsystems::ParseCommandLinePort(int32& OutPort)
{
